...
@Component
public class EditEmpleadoFormValidator implements Validator {
    private final EmpleadosService empleadosService;

    public EditEmpleadoFormValidator(EmpleadosService empleadosService) {
    ...
    public void validate(Object target, Errors errors) {
        ...
        Empleado originalEmpleado = empleadosService.getEmpleado(empleado.getId());
        ...
        if (!empleado.getDni().matches(originalEmpleado.getDni())) {
            if(empleadosService.existsEmpleado(empleado.getDni())){
                errors.rejectValue("dni", "Error.edit.empleado.dni.consistent");
            }
        }
    }
}